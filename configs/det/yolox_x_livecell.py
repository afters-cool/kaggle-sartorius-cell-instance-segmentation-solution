...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint="/home/testmony/workspace/yolox_kg_cots/pretrained_models/yolox_x_coco.pth",
            prefix="backbone",
        ),
    ),
    neck=None,
...
# data_root = "../data/"
data_root = (
    "/home/testmony/workspace/kg_sartorius/input/sartorius-cell-instance-segmentation/"
)
train_pipeline = [
    ...
    dict(type="MixUp", img_scale=img_scale, ratio_range=(0.5, 1.5), pad_val=114.0),
    dict(
...
custom_hooks = [
    ...
    dict(type="SyncNormHook", num_last_epochs=num_last_epochs, interval=1, priority=48),
