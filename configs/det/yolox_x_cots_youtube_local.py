...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/media/testmony/2TB_SSD/kg_cots/input/external_datasets/cots-seq-youtube-yolox-pseudo-v3/checkpoints/yolox_x_coco.pth',
            prefix='backbone'
        )
    ),
    neck=None,
...
dataset_type = 'COTSDataset'
#classes = ('shsy5y', 'a172', 'bt474', 'bv2', 'huh7', 'mcf7', 'skov3', 'skbr3')
classes = ('cots',)
#data_root = '../data/'
data_root = '/media/testmony/2TB_SSD/kg_cots/input/external_datasets/cots-seq-youtube-yolox-pseudo-v3'
train_pipeline = [
